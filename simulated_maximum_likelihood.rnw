...
\begin{align*}
  \label{eq:log_taylor}
  \log \check \Pr(n; \lambda, R) 
  & =
    \log P^{P}(n;\lambda) +\\
  & + \frac{1}{P^{P}(n;\lambda)} (\check \Pr(n; \lambda, R) - P^{P}(n;\lambda)) -
  \\
  & - \frac{1}{2 P^{P}(n;\lambda)^{2}} (\check \Pr(n; \lambda, R) - P^{P}(n;\lambda))^{2} +
    \\
  & + \frac{1}{3 P^{P}(n;\lambda)^{3}} (\check \Pr(n; \lambda, R) - P^{P}(n;\lambda))^{3} -
    \dots
\end{align*}
...
Hence we are looking for the expectation
\begin{align*}
  \label{eq:Elog_taylor}
  \E \log \check \Pr(n; \lambda, R) 
  & =
    \log P^{P}(n;\lambda) +\\
  & + \frac{1}{P^{P}(n;\lambda)} (\E\check \Pr(n; \lambda, R) - P^{P}(n;\lambda)) -
  \\
  & - \frac{1}{2 P^{P}(n;\lambda)^{2}} \E (\check \Pr(n; \lambda, R) - P^{P}(n;\lambda))^{2} +
    \\
  & + \frac{1}{3 P^{P}(n;\lambda)^{3}} \E (\check \Pr(n; \lambda, R) - P^{P}(n;\lambda))^{3} -
    \dots
\end{align*}
If $R$ is large, $\E\check \Pr(n; \lambda, R) \approx
P^{P}(n;\lambda)$ and we need few terms only.
